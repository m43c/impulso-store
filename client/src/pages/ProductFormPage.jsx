  ...
  return (
    <div className="form-container w-[300px] sm:w-[350px]">
      ...
      <form onSubmit={onSubmit}>
        ...
        />
        {errors.image && <p className="form-input-error">Image is required</p>}
        ...
        />
        {errors.price && <p className="form-input-error">Price is required</p>}

        <div className="flex justify-center space-x-4">
          <Link className="form-btn bg-orgBg hover:bg-orgHvr" to="/products">
            Back
          </Link>

          <button className="form-btn bg-grnBg hover:bg-grnHvr" type="reset">
            Reset
          </button>

          <button className="form-btn bg-bluBg hover:bg-bluHvr">Save</button>
        </div>
      </form>
    </div>
  );
